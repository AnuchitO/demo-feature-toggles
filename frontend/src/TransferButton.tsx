...
export const Icon = () => (<>
  <svg
    className="w-8 h-8 mr-3 text-gray-300 group-hover:text-white dark:group-hover:text-white"
...
export const LoadingIcon = () => (<>
  <svg aria-hidden="true" role="status" className="inline w-6 h-6 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
